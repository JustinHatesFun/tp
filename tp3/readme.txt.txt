...
The following modules were also installed either through the module_manager or pip: cv2, numpy, speech_recognition, google-api-python-client (requires additional setup to personal account), newspaper3k, and bs4.
